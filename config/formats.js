		...
		},
{
		...
		banlist: ['Uber', 'OU', 'UU', 'RU', 'NU', 'PU', 'Eviolite', 'Chansey', 'Dusclops', 'Scyther', 'Electabuzz', 'Porygon2', 'Rhydon', 'Haunter', 'Kadabra', 'Gurdurr', 'Magneton', 'Frogadier', 'Machoke', 'Doublade', 'Sneasel,
			'Gabite', 'Piloswine', 'Shelgon', 'Fraxure', 'Combusken', 'Clamperl', 'Munchlax', 'Gligar']
	},
];
